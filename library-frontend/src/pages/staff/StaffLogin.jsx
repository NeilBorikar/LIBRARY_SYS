    ...
    <div className="page-container flex items-center justify-center">
      ...
      >
        ...
        >
          ...
          <h1 className="text-3xl font-bold text-secondary-800 mb-2">College Staff Portal</h1>
          <p className="text-secondary-600">Enter your credentials to access your staff account</p>
        </motion.div>
